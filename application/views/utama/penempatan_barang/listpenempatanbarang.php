              ...
              <div class="">
                    ...
                    <div class="page-title">
                      <div class="title_left">
                            <h3>Kelola Transaksi Penempatan</h3>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-4 col-xs-4">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2> Tambah Penempatan Barang Baru</h2>
                                ...
                                <div class="x_content">
                                            ...
                                            <form method="post" action="<?php echo base_url();?>index.php/utama/adduser">
                                                <button type="submit" class="btn btn-success"> Tambah data penempatan </button>
                                            </form>
                                            </div>
                                        </div>
                                    ...
                                    <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td><?php echo $rows ['no_pe'];?> </td>
                                          <td><?php echo $rows ['nama_barang'];?> </td>
                                          <td><?php echo $rows ['kd_kategori']." ".$rows ['nama_kategori']." ";?> </td>
                                          <td><?php echo $rows ['merk'];?> </td>
                                          <td><?php echo $rows ['kondisi'];?> </td>
                                          <td><?php echo $rows ['tgl_perolehan'];?> </td>
                                          <td><?php echo $rows ['sumber_pengadaan'];?> </td>
                                          <td><?php echo $rows ['masa_pakai'];?> </td>
                                          <td align="left">
                                            <a  href="<?php echo site_url();?>/Ruangan/editruangan<?php echo $rows ['kd_barang'];?>"class="btn btn-xs btn-default"title="Edit" >
                                                <i class="fa fa-edit fa-fw"></i>
                                            </a>      
                                            <a  href="<?php echo site_url();?>/Ruangan/detailruangan<?php echo $rows ['kd_barang'];?>"class="btn btn-xs btn-default"title="Detail" >
                                                <i class="fa fa-list fa-fw"></i>
                                            </a>
                                             <a onclick="return confirm('Anda yakin akan menghapus  <?php echo $rows ['nama_barang'];?> ?')" href="<?php echo site_url();?>/Utama/deleteuser/<?php echo $rows ['kd_barang'];?>" class="btn btn-xs btn-default" title="Hapus">
