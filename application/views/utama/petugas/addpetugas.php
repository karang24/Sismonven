            ...
            <div class="right_col" role="main">
                ...
                <header class="head">          
                    <div class="main-bar bg-light dker">
                        ...
                        <a href="<?php echo site_url();?>/Utama/viewuser">Daftar User</a> /
                     <span class="active">
                            Tambah Data Petugas
                    </span>
                    </div><!-- /.main-bar -->
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <form class="form-horizontal form-label-left" method="post" action="<?php echo base_url();?>index.php/c_utama/insertuser" enctype="multipart/form-data">
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="id_petugas">ID Petugas <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="id_petugas"class="form-control col-md-7 col-xs-12" data-validate-length-range="5" data-validate-number="7" name="id_petugas" placeholder="Contoh : 10975125 " required="required" type="text">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="username" class="form-control col-md-7 col-xs-12" data-validate-length-range="10" data-validate-number="10" name="username" placeholder="masukkan username " required="required" type="text">
                                            </div>
                                        </div>
                                       <div class="item form-group">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="jabatan" type="text" name="jabatan" value="<?php echo set_value('jabatan'); ?>" data-validate-length-range="5,20" class="optional form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
