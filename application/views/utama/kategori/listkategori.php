             ...
             <!--nav link--> 
                <header class="head">          
                    <div class="main-bar bg-light dker">
                        ...
                        <a href="<?php echo site_url();?>/Kategori/addkategori">Tambah Kategori</a> /
                     <span class="active">
                        View Kategori
                    </span>
                    </div><!-- /.main-bar -->
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-4">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                            ...
                                            <form method="post" action="<?php echo base_url();?>index.php/Kategori/addkategori">
                                                <button type="submit" class="btn btn-success">Tambah data kategori</button>
                                            </form>
                                            </div>
                                        </div>
                                    </form>
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td align="left">
                                            ...
                                            <a  href="<?php echo site_url();?>/Kategori/editkategori<?php echo $rows ['kd_kategori'];?>"class="btn btn-xs btn-default"title="Edit" >
                                                <i class="fa fa-edit fa-fw"></i>
                                            </a>      
                                        
                           
                                            <a  href="<?php echo site_url();?>/Kategori/detailKategori/<?php echo $rows ['kd_kategori'];?>"class="btn btn-xs btn-default"title="Detail" >
                                                <i class="fa fa-list fa-fw"></i>
                                            </a>
                                           
                                            
                                             <a onclick="return confirm('Anda yakin akan menghapus  <?php echo $rows ['nama_kategori'];?> ?')" href="<?php echo site_url();?>/Utama/deletekategori/<?php echo $rows ['kd_kategori'];?>" class="btn btn-xs btn-default" title="Hapus">
