                        ...
                        <div class="col-md-4 col-sm-4 col-xs-4">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                            ...
                                            <form method="post" action="<?php echo base_url();?>index.php/ruangan/addruangan">
                                                <button type="submit" class="btn btn-success">Tambah data Ruangan</button>
                                            </form>
                                            </div>
                                        </div>
                                ...
                                <div class="x_content">
                                    ...
                                    <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                                      ...
                                      <tbody>
                                        ...
                                        <td><?php echo $rows ['kd_ruangan'];?></td>
                                        <td><?php echo $rows ['kd_gedung']." ".$rows ['nama_gedung']." ";?> </td>
                                        <td><?php echo $rows ['nama_ruangan'];?> </td>
                                        <td><?php echo $rows ['kapasitas'];?> </td>
                                        <td align="left">
                                            <a  href="<?php echo site_url();?>/Ruangan/editruangan<?php echo $rows ['kd_ruangan'];?>"class="btn btn-xs btn-default"title="Edit" >
                                                <i class="fa fa-edit fa-fw"></i>
                                            </a>      
                                            <a  href="<?php echo site_url();?>/Ruangan/detailRuangan/<?php echo $rows ['kd_ruangan'];?>"class="btn btn-xs btn-default"title="Detail" >
                                                <i class="fa fa-list fa-fw"></i>
                                            </a>
                                            <a onclick="return confirm('Anda yakin akan menghapus  <?php echo $rows ['nama_ruangan'];?> ?')" href="<?php echo site_url();?>/Ruangan/deleteruangan/<?php echo $rows ['kd_ruangan'];?>" class="btn btn-xs btn-default" title="Hapus">
