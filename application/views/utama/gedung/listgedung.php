             ...
             <!--nav link--> 
                <header class="head">          
                    <div class="main-bar bg-light dker">
                        ...
                        <a href="<?php echo site_url();?>/Gedung/addgedung">Tambah gedung</a> /
                     <span class="active">
                        View Gedung
                    </span>
                    </div><!-- /.main-bar -->
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-4">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                            ...
                                            <form method="post" action="<?php echo base_url();?>index.php/Gedung/addgedung">
                                                <button type="submit" class="btn btn-success">Tambah Data Gedung</button>
                                            </form>
                                            </div>
                                        </div>
                                    </form>
                            ...
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>View <small> Data Kategori</small></h2>
                                    <ul class="nav navbar-right panel_toolbox">
                                        <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                        </li>
                                        <li class="dropdown">
                                    ...
                                    <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td><?php echo $rows ['kd_gedung'];?> </td>
                                          <td><?php echo $rows ['nama_gedung'];?> </td>
                                          <td><?php echo $rows ['penanggung_jawab'];?> </td>
                                          <td align="left">
                                        
                                            <a  href="<?php echo site_url();?>/Gedung/editgedung<?php echo $rows ['kd_gedung'];?>"class="btn btn-xs btn-default"title="Edit" >
                                                <i class="fa fa-edit fa-fw"></i>
                                            </a>      
                                        
                                            <a  href="<?php echo site_url();?>/Gedung/detailGedung<?php echo $rows ['kd_gedung'];?>"class="btn btn-xs btn-default"title="Detail" >
                                                <i class="fa fa-list fa-fw"></i>
                                            </a>
                                         
                                             <a onclick="return confirm('Anda yakin akan menghapus  <?php echo $rows ['nama_gedung'];?> ?')" href="<?php echo site_url();?>/Gedung/deleteuser/<?php echo $rows ['kd_gedung'];?>" class="btn btn-xs btn-default" title="Hapus">
