            ...
            <div class="right_col" role="main">
              <div class="">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-4">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                            ...
                                            <form method="post" action="<?php echo base_url();?>index.php/Barang/addbarang">
                                                <button type="submit" class="btn btn-success">Entry Data Barang</button>
                                            </form>
                                            </div>
                                        </div>
                                    </form>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>View <small>Data Barang</small></h2>
                                    <ul class="nav navbar-right panel_toolbox">
                                        <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                        </li>
                                        <li class="dropdown">
