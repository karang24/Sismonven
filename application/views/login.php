            ...
            <div id="login" class="animate form">
                <section class="login_content">
                    <form method="post" action="<?php echo base_url();?>index.php/login/process">
                        ...
                        <div class="separator">
                            <div>
                                <h1><i style="font-size: 26px;"></i><img src="<?php echo base_url(); ?>assets/images/icon_ypbpi2.png"> Sistem Informasi Monitoring Inventaris YPBPI</h1>

                                <p>©2016 All Rights Reserved. Tugas Besar II. Niko Gurnanto 2133008</p>
                            </div>
                        </div>
                    </form>
                    <!-- form -->
